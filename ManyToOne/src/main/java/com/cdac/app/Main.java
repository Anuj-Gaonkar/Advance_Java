...
//		Student s1 = dao.fetchByStudentId(1);
		...
		/*Student s1 = dao.fetchByStudentId(8);
		Student s2 = dao.fetchByStudentId(9);
		Student s3 = dao.fetchByStudentId(10);
...
//		Branch b4 = new Branch("pG-DAC", "Dr. C. P. Johnson");
		
		Branch b4 = dao.fetchByBranchId(4);
		
		/*Student s1 = new Student("Ashok", "Pate", "ashok@gmail");
		Student s2 = new Student("Akshay", "Patil", "akshay@gmail");
		Student s3 = new Student("Akash", "Shinde", "akash@gmail");
		
		dao.addStudent(s1);
		dao.addStudent(s2);
		dao.addStudent(s3);*/
		
		Student s1 = dao.fetchByStudentId(11);
		Student s2 = dao.fetchByStudentId(12);
		Student s3 = dao.fetchByStudentId(13);
